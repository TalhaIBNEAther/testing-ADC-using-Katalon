...
WebUI.click(findTestObject('Object Repository/ADC Co/Login Cases/change language on login page/Page_Admin Panel/button_English'))

WebUI.click(findTestObject('Object Repository/ADC Co/Login Cases/change language on login page/Page_Admin Panel/li_'))
...
WebUI.verifyElementText(findTestObject('Object Repository/ADC Co/Login Cases/change language on login page/Page_Admin Panel/h1_Sign in'), 
    'Sign In')

WebUI.takeScreenshotAsCheckpoint('Sign In')
